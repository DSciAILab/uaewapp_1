...
if st.session_state.user_confirmed and st.session_state.current_user_name!="User":
    ...
    if df_athletes.empty:
        ...
        for i_l, row in df_filtered.iterrows():
            ...
            with col_card:
                # --- CORREÇÃO: Lógica de cor do card ---
                card_bg_col = "#2E2E2E" # Padrão
                if curr_ath_task_stat == "Done": card_bg_col = "#143d14"
                elif curr_ath_task_stat == "Requested": card_bg_col = "#B08D00"
                ...
                if mob_r:
                    ...
                    if phone_digits: wa_link_html = f"""<p style='margin-top: 8px; font-size:14px; text-align:left;'><a href='https://wa.me/{html.escape(phone_digits, True)}' target='_blank' style='color:#FFF; text-decoration:none; font-weight:bold;'> WhatsApp</a></p>"""
                ...
                <div style='background-color:{card_bg_col}; padding: 20px; border-radius: 10px;'>
                    <div style='display:flex; align-items:center; gap:20px;'>
                        ...
                        <div style='flex-grow: 1;'>
                            ...
                            {wa_link_html if not st.session_state.show_personal_data else ''}
                        </div>
