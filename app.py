...
def apply_custom_css():
    img_bg = get_img_as_base64("background.jpg")  # Substitua pelo caminho real se tiver imagem
...
st.markdown("""
    <div class="footer">
        UAE Warriors App v2.0.0 | Sistema de Gerenciamento de Atletas | Desenvolvido com Streamlit
    </div>
""", unsafe_allow_html=True)
