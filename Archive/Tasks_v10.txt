...
import html
import altair as alt # Importação para o gráfico de barras
...
if st.session_state.user_confirmed and st.session_state.current_user_name!="User":
    ...
    if sel_task_actual and not df_athletes.empty:
        ...
        # --- ATUALIZAÇÃO: Gráfico de Barras para Estatísticas ---
            ...
            with col_card:
                ...
                <div style='background-color:#2E2E2E; border-left: 5px solid {status_bar_color}; padding: 20px; border-radius: 10px;'>
                    <div style='display:flex; align-items:center; gap:20px;'>
                        ...
                        <div>
                            <h4 style='margin:0; font-size:1.6em; line-height: 1.2;'>
                                {html.escape(ath_name_d)} <span style='font-size:0.6em; color:#cccccc; font-weight:normal; margin-left: 8px;'>{html.escape(ath_event_d)} (ID: {html.escape(ath_id_d)})</span>
                            </h4>{wa_link_html}
                        </div>
                    </div>{pd_tbl_h}
                ...
                status_color_map = {"Done": "#1E8449", "Requested": "#F39C12", "---": "#34495E"}
