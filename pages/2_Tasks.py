...
# --- 2. Google Sheets Connection (Movido para utils.py) ---
...
default_ss = {
    "show_personal_data": True, "selected_task": NO_TASK_SELECTED_LABEL, 
...
with cc3:st.markdown("<br>",True);st.button("🔄 Atualizar",key="ref_b_w",help="Recarrega dados.",on_click=lambda:(load_athlete_data.clear(), load_config_data.clear(), load_attendance_data.clear(), st.toast("Dados atualizados!",icon="🔄"),st.rerun()),use_container_width=True)
